...
- **Difficulty**: `Medium`
- **Tags / Topics**: `String`, `Depth-First Search`, `Breadth-First Search`, `Enumeration`
- **Link**: [Leetcode](https://leetcode.com/problems/lexicographically-smallest-string-after-applying-operations/)
