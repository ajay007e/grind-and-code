...
- **Difficulty**: `Medium`
- **Tags / Topics**: `Array`, `String`, `Depth-First Search`, `Trie`
- **Link**: [Leetcode](https://leetcode.com/problems/remove-sub-folders-from-the-filesystem/)
...
<details>
<summary>Click to read Java code</summary>
